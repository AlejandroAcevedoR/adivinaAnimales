...
public class View extends javax.swing.JFrame {
    ...
    //inicialicazion del arbol, valores auxiliares
    ...
    public View() throws IOException {
        ...
        //asegura que el arbol este actualizado al abrir la ventana
        adivinador.inicio();
    ...
    private void noActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_noActionPerformed
        //hace que se mueva al nodo derecho en caso de que el nodo actual sea una pregunta, en caso de que no lo sea se inserta un nuevo nodo si el nodo actual es una respuesta
        ...
        if(!(aux.getInfo().equals("Tiene que ser un animal") || aux.getInfo().equals("¡Adiviné!") || aux.getInfo().equals("Inicio: intentar de nuevo") || jlabel6.getText().equals("Inicio: intentar de nuevo"))){
            ...
            //se abre la ventana de insercion de conocimientos si es necesario
            if(aux.isPregunta() == false){
                ...
                //aqui se maneja la transferencia de informacion desde el jDialog hacia el jFrame mientras permanzzca abierta
                while(pausa == false){
                ...
                //utilizacion de los valores del jDialog
                ...
                //maneja casos de texto hacia el usuario            
    ...
    private void siActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_siActionPerformed
        //hace que se mueva al nodo izquierdo en caso de que el nodo actual sea una pregunta, en caso de que no lo sea se inserta un nuevo nodo si el nodo actual es una respuesta
    ...
    private void iniciarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_iniciarActionPerformed
        //regresa nuestra posicion a la raiz del arbol para jugar de nuevo
        aux = adivinador.getRaiz();
        jlabel6.setText(aux.getInfo());
    }//GEN-LAST:event_iniciarActionPerformed

    private void resetearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_resetearActionPerformed
        //regresa el arbol a sus valores default dados por inicio, y cambia la base de conocimientos de acorde
        try {
            Tree adivinador = new Tree();
            adivinador.inicio();
            adivinador.resetear();
